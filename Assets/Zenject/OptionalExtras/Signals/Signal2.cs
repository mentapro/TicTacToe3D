...
#if ZEN_SIGNALS_ADD_UNIRX
        readonly Subject<ValuePair<TParam1, TParam2>> _stream = new Subject<ValuePair<TParam1, TParam2>>();
#endif

#if ZEN_SIGNALS_ADD_UNIRX
        public IObservableRx<ValuePair<TParam1, TParam2>> Stream
        {
            get
            {
                return _stream;
...
#endif
                {
                    _stream.OnNext(ValuePair.New(p1, p2));
                }
#endif
