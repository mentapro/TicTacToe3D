...
{
    // Six Parameters
    public abstract class Signal<TDerived, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> : ISignal
        where TDerived : Signal<TDerived, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>
    {
        readonly List<ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>> _listeners = new List<ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>>();
        ...
        public static TDerived operator + (Signal<TDerived, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> signal, ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> listener)
        {
        ...
        public void Fire(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6)
        {
            // Use ToArray in case they remove in the handler
            foreach (var listener in _listeners.ToArray())
            {
                listener(p1, p2, p3, p4, p5, p6);
            }
        }
    }
}
